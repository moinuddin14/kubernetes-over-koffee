...
This repository contains everything from the Kubernetes over Koffee meetup sessions details, resources, issues that we have solved through these meetups and everything else in and around kubernetes and its ecosystem of tools and products. 

![Kubernetes over Koffee](images/kubernetes%20over%20koffee%20image.png)


# Meetup Home Page
You can find all the meetup sessions, both present, past and future [here](https://www.meetup.com/kubernetes-over-koffee/)

# All Meetup Sessions 

| Title | Date | URL | Status | Venue | Feedback |
|-------|------|-----|--------|----------|----------|
| Kubernetes Dynamic Resource Allocation (DRA) | Saturday, Aug 30, 2025 | _https://www.meetup.com/kubernetes-over-koffee/events/310710644/_ | Done | Chayoos cafe, Divyashree, Lanco hills, Hyderabad | None |
| Kubernetes Common Expression Language (CEL) | Saturday, Sep 6, 2025 | _https://www.meetup.com/kubernetes-over-koffee/events/310775764/_ | Done | Kodryx AI @ Siri Park View Apartment, Plot no 49, Guttala_Begumpet, Kavuri Hills, Madhapur, Hyderabad, Telangana 500033 · Hyderabad | None |
| Code, Coffee & Community: Let's Kickoff Hacktoberfest! | Sunday, Sep 28, 2025 | _https://www.meetup.com/kubernetes-over-koffee/events/311252438/_ | Done | Online event | None |
| Kubernetes Scheduler Deep Dive: Internals, Customization & Advanced Tuning | Saturday, Oct 11, 2025 | _https://www.meetup.com/kubernetes-over-koffee/events/311163787/_ | Done | ASBL Tech, Elite Coworking Aurobindo Orbit-2, Elite by Awfis, Aurobindo Orbit, Tower 1, 4th Floor, Plot No 30/C part of Sy.No. 83/1, Hyderabad | None |
